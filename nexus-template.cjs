...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Emergency Response Command Center";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "EmergencyIncident";
process.env.TABLE_NAME = process.env.TABLE_NAME || "emergencyincident_records";
'use strict';
